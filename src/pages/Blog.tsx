    ...
    <PageLayout>
      ...
      <Section className="pt-24">
        <Header
          ...
          subtitle="Expert insights on web development, student projects, and digital growth"
          badge="Fresh Insights & Expert Tips"
          titleGradient
          centered
        />
        ...
        <Section className="py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {featuredPosts.map((post) => (
              <Card 
                key={post.id} 
                className="group hover:shadow-xl transition-all duration-300 hover:transform hover:scale-105 border-0 bg-white/80 backdrop-blur-sm overflow-hidden"
              >
                <CardContent className="p-0">
                  <div className="bg-gradient-to-br from-purple-100 to-cyan-100 p-8 text-center">
                    <div className="text-6xl mb-4">{post.image}</div>
                    <Badge className="bg-gradient-to-r from-purple-600 to-cyan-400 text-white">
                      Featured
                    </Badge>
                  </div>
                  <div className="p-6">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-1 mb-4">
                    {post.tags.slice(0, 2).map((tag, index) => (
                      <Badge key={index} variant="gradient-blue">
                        {tag}
                      </Badge>
                    ))}
                  </div>
      ...
      {/* Newsletter CTA */}
      <Section withGradient className="from-purple-600 via-blue-600 to-cyan-500">
        <div className="text-center">
          <Header
            title="Stay Updated with Latest Insights"
            subtitle="Get weekly articles, project ideas, and career tips delivered to your inbox"
            centered
