  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <SEO 
        ...
        description="Read the official Terms of Service for using Design Deliver Grow's automation tools, services, and digital products."
      />
      ...
      <div className="prose prose-lg">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>All prices for services, automation tools, or digital products are displayed in INR (₹) and are subject to applicable taxes.</li>
